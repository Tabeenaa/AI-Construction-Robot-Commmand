...
def run_tests() -> None:
    console.print(Panel.fit(
        ...
        "[dim]Constitutional AI (Bai et al. 2022) · Powered by Google Gemini · 17 Commands[/dim]\n"
        f"[dim]Using model: gemini-1.5-flash | Delay between tests: {INTER_TEST_DELAY}s[/dim]",
        border_style="cyan"
    ))

    checker = RobotSafetyChecker(model="gemini-1.5-flash")
